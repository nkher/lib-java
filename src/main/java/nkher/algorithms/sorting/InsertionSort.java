...
/****
 * Implementation of the classic insertion sort algorithm. It works well for array sizes
 * less than 50.
 * 
 * @author nameshkher
 *
...
public class InsertionSort extends Sorting {
	...
	/***
	 * Sorts the passed array in order provided by the sort order parameter using the classic insertion sort algorithm.
		...
		for (i=1; i<n; i++) {
			...
			while (j != 0) {
				if (sortOrder == ORDER_ASC) {
					if (dArray.getAt(j).compareTo(dArray.getAt(j-1)) < 1) {
						swap(dArray, j, j-1);
						j--;
					}
					else break;
					...
					if (dArray.getAt(j-1).compareTo(dArray.getAt(j)) < 1) {
						swap(dArray, j, j-1);
						j--;
					}
					else break;
	...
	/***
	 * Sorts the Integer[] array using the insertion sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Character[] array using the insertion sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Short[] array using the insertion sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Long[] array using the insertion sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Byte[] array using the insertion sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Double[] array using the insertion sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Float[] array using the insertion sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the int[] array using the insertion sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the char[] array using the insertion sort algorithm.
	 * 
	 * @param carray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the boolean[] array using the insertion sort algorithm.
	 * 
	 * @param barray
	 * @param sortOrder
	 */
