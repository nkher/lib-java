...
/****
 * Implementation of the classic selection sort algorithm. It works well for array sizes
 * less than 50.
 * 
 * @author nameshkher
 *
...
public class SelectionSort extends Sorting {
	...
	/***
	 * Sorts the passed array in order provided by the sort order parameter using the classic selection sort algorithm.
	...
	public static <T extends Comparable<T>> void sort(DynamicArray<T> dArray, int sortOrder) {
		...
		for (i=0; i<n-1; i++) {
			int minIndex = i; // the current min index where the smallest element is to be placed
			for(j=minIndex+1; j<n; j++) {
				
				T elemAtMI = dArray.getAt(minIndex), elemAtI = dArray.getAt(j);
				if (Sorting.ORDER_ASC == sortOrder) {
					if (elemAtMI.compareTo(elemAtI) > 0) {
						swap(dArray, minIndex, j);
					}
				}
				else if(Sorting.ORDER_DESC == sortOrder) {
					if (elemAtI.compareTo(elemAtMI) > 0) {
						swap(dArray, minIndex, j);
					}
				}
			}
	...
	/***
	 * Sorts the Integer[] array using the selection sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Character[] array using the selection sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Short[] array using the selection sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Long[] array using the selection sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Byte[] array using the selection sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Double[] array using the selection sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the Float[] array using the selection sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the int[] array using the selection sort algorithm.
	 * 
	 * @param iArray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the char[] array using the selection sort algorithm.
	 * 
	 * @param carray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the boolean[] array using the selection sort algorithm.
	 * 
	 * @param barray
	 * @param sortOrder
	 */
	...
	/***
	 * Sorts the String[] array using the selection sort algorithm.
	 * 
	 * @param sarray
	 * @param sortOrder
	 */
